    ...
    <div class="approved-actions-img">
        ...
        <div class="btn-inlane-content btn-inlane-content-btn3 noty_successfull">
            <div class="driver-profile-text">
                ...
                <b>Reason for termination:</b> <br> {{notification.data.note}}.<br><br>
                Please return the vehicle on <b>{{notification.data.requested_data.end_date | date('format', 'DD.MM.YYYY') }}</b>
            </div>
        </div>
    </div>
</template>
