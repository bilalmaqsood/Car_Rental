    ...
    <div class="main_booking_container">
        <div class="booking_container">
            ...
            <transition name="flip" mode="out-in">
                <div v-if="bookings.length" key="booking-list">
                    ...
                    <div class="booking_tab">
                        <ul class="nav nav-tabs">
                            <li>
                                <a href="javascript:void(0)" @click="car_inpec=!car_inpec">
                            ...
                            <li v-if="User.state.auth.type=='client'">
                                <a href="javascript:void(0)" @click="extend_cancel=!extend_cancel">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 17 15" class="svg-icon">
                                        <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#availability_results"></use>
                                    </svg>
                                    extend/cancel
                            ...
                            <li v-if="User.state.auth.type=='owner'">
                            ...
                            <li>
                                <a href="javascript:void(0)" @click="booking_docs=!booking_docs">
                            ...
                            <li>
                                <a href="javascript:void(0)" @click="booking_chat=!booking_chat">
