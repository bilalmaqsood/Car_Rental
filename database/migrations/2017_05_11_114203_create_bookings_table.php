...
class CreateBookingsTable extends Migration
{
    ...
    public function up()
    {
        ...
        DB::statement('ALTER TABLE `bookings` MODIFY `status` TINYINT(2) NOT NULL DEFAULT 0 COMMENT \'0=Requested, 1=Confirmed, 2=Signed by client, 3=Signed by owner, 4=Accepted, 5=Termination, 6=Terminated, 7=Extend, 8=Extended, 9=Close, 10=Disputed, 11=Resolved, 12=Deposit Returned\';');
    }
